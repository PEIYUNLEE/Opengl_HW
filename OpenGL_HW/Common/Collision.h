...
class Collision {
public:
	bool OnBoxCollision(mat4 mat_Object, float *cObjectRadius, EnemyManager *getEnemyList);
	...
	bool OnBoxCollision(mat4 mat_Object, float *cObjectRadius, mat4 mat_Main, float *cPBoatRadius);
};